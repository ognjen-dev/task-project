...
// <div className="lg:ml-2 ml-1 flex bg-gray-50 font-semibold py-1 rounded-md lg:w-full">
//   <div className="flex flex-row items-center mx-2 lg:mr-0">{/* changed mr-5 to mx-2 */}
//     <div className="">
//       <input
//         type="text"
//         placeholder="Search Projects"
//         className="w-3/5 lg:text-md text-xs lg:w-full md:w-full sm:mr-44 -mr-2 xl:-mr-6 lg:-mr-6 lg:mr-52 font-semibold outline-none bg-gray-50 ml-4 py-2 md:py-1"
//       />
//     </div>
//     <div className="">
//       <svg
